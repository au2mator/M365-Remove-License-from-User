...
# Type: New Service
#
# Title: M365 - Remove Office 365 License
#
...
# Code Template V 1.3
#
# URL: https://au2mator.com/remove-office-365-license-microsoft-365-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=M365_RemoveLicense&utm_content=PS1
# Github: https://github.com/au2mator/M365-Remove-License-from-User
#################
...
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\M365 - Remove Office 365 License"
[string]$LogfileName = "Remove Office 365 License"
...
"@
            ...
            $au2matorReturn = "The License $C_license($SKUID) was removed from  User $UPN"
            $AdditionalHTML = "The License $C_license($SKUID) was removed from User $UPN
            <br>
            "
            $Status = "COMPLETED"
        }
            ...
            Write-au2matorLog -Type ERROR -Text "Could not remove the License"
            Write-au2matorLog -Type ERROR -Text "Error: $Error"

            $au2matorReturn = "Could not remove the License, Error: $Error"
            $AdditionalHTML = "Could not remove the License
            <br>
            Error: $Error
            "
            $Status = "ERROR"
